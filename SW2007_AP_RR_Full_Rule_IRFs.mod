...
IRF_OUTPUT_TFP_FULL_RR = oo_.irfs.y_ea;
IRF_INFLATION_TFP_FULL_RR = oo_.irfs.pinf_ea;
IRF_NOMINAL_TFP_FULL_RR = oo_.irfs.r_ea;

IRF_OUTPUT_RP_FULL_RR = oo_.irfs.y_eb;
IRF_INFLATION_RP_FULL_RR = oo_.irfs.pinf_eb;
IRF_NOMINAL_RP_FULL_RR = oo_.irfs.r_eb;

IRF_OUTPUT_G_FULL_RR = oo_.irfs.y_eg;
IRF_INFLATION_G_FULL_RR = oo_.irfs.pinf_eg;
IRF_NOMINAL_G_FULL_RR = oo_.irfs.r_eg;

IRF_OUTPUT_I_FULL_RR = oo_.irfs.y_eqs;
IRF_INFLATION_I_FULL_RR = oo_.irfs.pinf_eqs;
IRF_NOMINAL_I_FULL_RR = oo_.irfs.r_eqs;

IRF_OUTPUT_M_FULL_RR = oo_.irfs.y_em;
IRF_INFLATION_M_FULL_RR = oo_.irfs.pinf_em;
IRF_NOMINAL_M_FULL_RR = oo_.irfs.r_em;

IRF_OUTPUT_PINF_FULL_RR = oo_.irfs.y_epinf;
IRF_INFLATION_PINF_FULL_RR = oo_.irfs.pinf_epinf;
IRF_NOMINAL_PINF_FULL_RR = oo_.irfs.r_epinf;

IRF_OUTPUT_W_FULL_RR = oo_.irfs.y_ew;
IRF_INFLATION_W_FULL_RR = oo_.irfs.pinf_ew;
IRF_NOMINAL_W_FULL_RR = oo_.irfs.r_ew;

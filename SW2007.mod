...
estimation(mh_tune_jscale,datafile=SW_Updated_Data,mode_compute=9,first_obs=1, presample=4,lik_init=2,prefilter=0,mh_replic=2000000,mh_nblocks=1,mh_drop=0.2, nograph, tex,mode_check);

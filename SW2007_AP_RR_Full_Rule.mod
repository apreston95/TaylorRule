...
csigl,2.8401,0,5,NORMAL_PDF,2,0.75;
...
phia,-0.08,UNIFORM_PDF,,,-4,4;
phib,1.13,UNIFORM_PDF,,,-4,4;
phig,0.04,UNIFORM_PDF,,,-4,4;
phiqs,0.03,UNIFORM_PDF,,,-4,4;
phispinf,0.45,UNIFORM_PDF,,,-4,4;
phisw,-0.17,UNIFORM_PDF,,,-4,4;

phiewma,0,UNIFORM_PDF,,,-4,4;
phiepinfma,0,UNIFORM_PDF,,,-4,4;
phiyf,0,UNIFORM_PDF,,,-4,4;
phiy,0,UNIFORM_PDF,,,-4,4;
phir,0,UNIFORM_PDF,,,-4,4;
phikpf,0,UNIFORM_PDF,,,-4,4;
phikp,0,UNIFORM_PDF,,,-4,4;
phicf,0,UNIFORM_PDF,,,-4,4;
phiinvef,0,UNIFORM_PDF,,,-4,4;
phic,0,UNIFORM_PDF,,,-4,4;
phiinve,0,UNIFORM_PDF,,,-4,4;
phipinf,0,UNIFORM_PDF,,,-4,4;
phiw,0,UNIFORM_PDF,,,-4,4;
...
% estimation(posterior_sampling_method='tailored_random_block_metropolis_hastings',datafile=usmodel_data,mode_compute=6,optim=('NumberOfMh',6),first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=20000,mh_nblocks=1,tex,mode_check,mh_drop=0.2);
estimation(datafile=SW_Updated_Data,mode_compute=6,optim=('ncov-mh',600000),first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=4000000,mh_nblocks=1,tex,mode_check,mh_drop=0.25,conditional_variance_decomposition = 4);
% estimation(datafile=SW_Updated_Data,mode_compute=5,first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=1000000,mh_nblocks=1,tex,mode_check,mh_drop=0.25,conditional_variance_decomposition = 4);

% estimation(datafile=SW_Updated_Data,mode_compute=8,optim=('MaxIter',50000000,'MaxFunEvals',50000000),first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=1000000,mh_nblocks=1,tex,mode_check,mh_drop=0.25,conditional_variance_decomposition = 4);
% estimation(datafile=SW_Updated_Data,mode_compute=0,mode_file=SW2007_AP_RR_NoSmooth_Long_Sample_Mode,first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=4000000,mh_nblocks=1,tex,mode_check,mh_drop=0.2,conditional_variance_decomposition = 4);
% estimation(mh_tune_jscale,mode_file=SW2007_AP_RR_NoSmooth_Short_Sample_Mode,datafile=usmodel_data,mode_compute=0,first_obs=1,presample=4,lik_init=2,prefilter=0,irf=30,mh_replic=6000000,mh_nblocks=1,tex,mode_check,mh_drop=0.2,conditional_variance_decomposition = 4);

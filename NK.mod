...
stoch_simul(order = 1,irf=15,periods = 10000);
...
estimation(mh_tune_jscale,datafile=NK_Data,mode_compute=9,cova_compute=1,mode_check,mh_replic=100000,tex) Y R Pi;

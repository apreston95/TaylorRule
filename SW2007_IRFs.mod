...
stoch_simul(order = 1, irf=31,nograph,periods=100000) y pinf r yf g;
save SW2007_sim y r pinf yf;


       

IRF_OUTPUT_TFP_TR = oo_.irfs.y_ea;
IRF_INFLATION_TFP_TR = oo_.irfs.pinf_ea;
IRF_NOMINAL_TFP_TR = oo_.irfs.r_ea;

IRF_OUTPUT_RP_TR = oo_.irfs.y_eb;
IRF_INFLATION_RP_TR = oo_.irfs.pinf_eb;
IRF_NOMINAL_RP_TR = oo_.irfs.r_eb;

IRF_OUTPUT_G_TR = oo_.irfs.y_eg;
IRF_INFLATION_G_TR = oo_.irfs.pinf_eg;
IRF_NOMINAL_G_TR = oo_.irfs.r_eg;

IRF_OUTPUT_I_TR = oo_.irfs.y_eqs;
IRF_INFLATION_I_TR = oo_.irfs.pinf_eqs;
IRF_NOMINAL_I_TR = oo_.irfs.r_eqs;

IRF_OUTPUT_M_TR = oo_.irfs.y_em;
IRF_INFLATION_M_TR = oo_.irfs.pinf_em;
IRF_NOMINAL_M_TR = oo_.irfs.r_em;

IRF_OUTPUT_PINF_TR = oo_.irfs.y_epinf;
IRF_INFLATION_PINF_TR = oo_.irfs.pinf_epinf;
IRF_NOMINAL_PINF_TR = oo_.irfs.r_epinf;

IRF_OUTPUT_W_TR = oo_.irfs.y_ew;
IRF_INFLATION_W_TR = oo_.irfs.pinf_ew;
IRF_NOMINAL_W_TR = oo_.irfs.r_ew;
